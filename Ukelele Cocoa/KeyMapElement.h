...
public:
	...
	static ErrorMessage CreateFromXML(NSXMLElement *inXMLTree, KeyMapElement*& outElement, shared_ptr<XMLCommentContainer> ioCommentContainer);
...
public:
	...
	void AddToXML(NSXMLElement *inXMLTree);
